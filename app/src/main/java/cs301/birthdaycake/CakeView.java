...
public class CakeView extends SurfaceView {
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        float candleStart = cakeLeft + cakeWidth/2 - candleWidth/2 - candleWidth * cake.candleCount / 2;
        for (int i = 0; i < cake.candleCount; i++) {
            drawCandle(canvas, candleStart + i * candleWidth, cakeTop);
        }
